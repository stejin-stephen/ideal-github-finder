...
export default function Search(props: Props) {
  return (
    <form onSubmit={props.onSubmit} className='flex items-center gap-2 shadow-md focus-within:ring-1 dark:focus-within:ring-gray-200 focus-within:ring-slate-800 p-2 rounded-lg dark:bg-slate-700 bg-slate-100'>
